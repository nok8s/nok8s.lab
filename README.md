<div align="center">
    <a href="https://nok8s.io"><h1 align="center">nok8s.lab</h1></a>

My personal website, built with [Next.js](https://nextjs.org/), [Tailwind CSS](https://tailwindcss.com/), [Upstash](https://upstash.com?ref=nok8s.io), [Contentlayer](https://www.contentlayer.dev/) and deployed to [Vercel](https://vercel.com/).
...
```sh-session
git clone https://github.com/nok8s/nok8s.lab.git
cd nok8s.io
```
